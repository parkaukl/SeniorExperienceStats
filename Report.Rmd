...
```{r}
 load("Workspace.RData") # This is data that had previously been collected from the previous files. I could also cretae an abbreviated file that shares my important codes.
```
## Abstract 
...
The decision to go to war is a complex decision that has severe consequences. 
