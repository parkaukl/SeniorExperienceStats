...
```{r, fig.cap="Differences in estimates of Public Opinion within Each State, from an MRP and a Simple Disaggregation Model"}
...
The effects of age are also illustrated on Table 2. Respondents who are aged 25 to 34 were 2.76% less likely to believe that war was effective when compared to 
...
```{r,fig.cap="The 95% Credible Intervals of Estimates for the Coefficients in the Bayesian Model"}
plot(mcmc_intervals(ProWar_Model_Posterior,pars = BayesianCoefficientList[1:10]),prob_outer=.95)
```
