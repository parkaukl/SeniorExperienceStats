...
This paper will also build a logistic regression under a Bayesian framework. This would require us to set our priors. These priors would be based on the background research, mostly from the regressions that are in Gelpi and Feaver (2009).
