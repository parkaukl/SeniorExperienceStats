...
ggplot(ChicagoForeignCouncilClean,aes(x=StatementNumber,fill=ProWarFactor))+geom_bar(position=position_fill())+xlab("Position that the Statement was Shown In")+ylab("Proportion of Respondents")+scale_fill_discrete(name = "ProWarFactor", labels = c("Military Intervention is not Effective","Military Intervention is Effective"))
```
...
ggplot(ChicagoForeignCouncilClean,aes(x=Region9,fill=ProWarFactor))+geom_bar(position=position_fill())+xlab("Region the Respondent Lives In")+ylab("Proportion of Respondents")+scale_fill_discrete(name = "ProWarFactor", labels = c("Military Intervention is not Effective","Military Intervention is Effective"))+theme(axis.text.x=element_text(angle=90))
```
