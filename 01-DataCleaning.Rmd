...
print(coefficients)
poststratify<-coefficients %>%
  mutate(FeNoHS18_24=invlogit(Intercept),
         ...
         FeHSSome18_24=invlogit(Intercept+SomeCollege),
         FeHSSome25_34=invlogit(Intercept+SomeCollege+A25.34),
         FeHSSome35_44=invlogit(Intercept+SomeCollege+A35.44),
         FeHSSome45_64=invlogit(Intercept+SomeCollege+A45.64),
         FeHSSome65=invlogit(Intercept+SomeCollege+A65Plus),
         ...
         MaGrad65=invlogit(Intercept+MALE+Graduate+A65Plus)) #%>%
 
#   select(-Intercept,-MALE,-HSGrad,-SomeCollege,-Bachelor,-Graduate,-A25.34,-A35.44,-A45.64,-A65Plus)


print(poststratify)

poststratify<-poststratify[,11:60]
```
